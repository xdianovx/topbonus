                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="flex-grow-1">
                                        <h5 class="card-header align-items-center d-flex">Certificat: {{ $item->title }}</h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1" style="">
                                                <li>
                                                    <a type="button" class="dropdown-item" href="{{ route('admin.certificates.index') }}">
                                                        <i class="ri-arrow-left-line align-bottom me-2 text-muted"></i> Back</a>
                                                </li>

                                                <li><a href="{{ route('admin.certificates.edit', $item->id) }}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                <li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th class="ps-0" scope="row">Link:</th>
                                                    <td class="text-muted">{{$item->link}}</td>
                                                </tr>
                                                <tr>
                                                    <th class="ps-0" scope="row">Casino:</th>
                                                    <td class="text-muted">{{$item->casino->title}}</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('admin.certificates.destroy', $item->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
