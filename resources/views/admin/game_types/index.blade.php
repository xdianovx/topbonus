            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.game_types.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.game_types.create') }}" class="btn btn-success addMembers-modal">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                                ...
                                <tbody>
                                    @forelse ($game_types as $item)
                                        <tr>
                                            ...
                                            <td><a
                                                    href="{{ route('admin.game_types.show', $item->slug) }}">{{ $item->title }}</a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.game_types.show', $item->slug) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.game_types.destroy', $item->slug) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        @if ($game_types->links()->paginator->hasPages())
                            {{ $game_types->links() }}
                        @endif
                    </div>
                </div>
