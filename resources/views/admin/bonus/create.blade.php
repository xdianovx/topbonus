            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.bonus_cards.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" value="{{ old('max_cash_out') }}" class="form-control"
                                            id="valueInput" name="max_cash_out" placeholder="Enter text">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    ...
                                    <input type="date" class="form-control" value="{{ old('expired_date') }}"
                                        id="exampleInputdate" name="expired_date">
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        <label for="valueInput" class="form-label">Bonus Code *</label>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    ...
                                    @if (!count($bonus_types) == 0)
                                        <select type="text" data-choices class="form-control" name="bonus_type_id"
                                            id="valueInput">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    ...
                                    @if (!count($casinos) == 0)
                                        <select type="text" data-choices class="form-control" name="casino_id"
                                            id="valueInput">
