                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" value="{{ $item->refferal_link }}" class="form-control"
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" value="{{ $item->max_cash_out }}" class="form-control"
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    ...
                                    <input type="date" value="{{ $item->expired_date }}" class="form-control"
