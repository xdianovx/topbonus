                        ...
                        <div class="row g-2">
                            <div class="col-sm-4">
                                <div class="search-box">
                                    <form class="d-flex" action="{{ route('admin.softs.search') }}" method="get">
                                        @csrf
                            ...
                            <div class="col-sm-auto ms-auto">
                                <div class="list-grid-nav hstack gap-1">
                                    ...
                                    <a href="{{ route('admin.softs.create') }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                            ...
                                            <tbody>
                                                @forelse ($softs as $item)
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="{{ route('admin.softs.show', $item->slug) }}">{{ $item->title }}</a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="dropdown d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end" style="">
                                                                    <li><a href="{{ route('admin.softs.show', $item->slug) }}"
                                                                            class="dropdown-item"><i
                                                                                class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                            View</a></li>
                                                                    <li><a href="{{ route('admin.softs.edit', $item->slug) }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.softs.destroy', $item->slug) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                    ...
                                    @if ($softs->links()->paginator->hasPages())
                                        {{ $softs->links() }}
                                    @endif
                                </div>
                            </div>
