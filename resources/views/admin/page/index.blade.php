                        ...
                        <div class="card">
                            <div class="demo-inline-spacing">
                                @if (session('status') === 'item-updated')
                                    <div class="alert alert-primary alert-dismissible" role="alert">{{ __('Updated successfully.') }}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                                ...
                                                                <div class="input-group">
                                                                    <img src="{{ Storage::url($item->image) }}" class="rounded avatar-sm">
                                                                </div>
                                                            @else
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="dropdown d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end" style="">
                                                                    <li><a href="{{ route('admin.categories.show', $item->slug) }}" class="dropdown-item"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
