            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.games.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.games.create') }}" class="btn btn-success addMembers-modal">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                                ...
                                <tbody>
                                    @forelse ($games as $item)
                                        <tr>
                                            ...
                                            <td><a
                                                    href="{{ route('admin.games.show', $item->slug) }}">{{ $item->title }}</a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.games.show', $item->slug) }}"
                                                                class="dropdown-item"><i
                                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                View</a></li>
                                                        <li><a href="{{ route('admin.games.edit', $item->slug) }}"
                        ...
                        @if ($games->links()->paginator->hasPages())
                            {{ $games->links() }}
                        @endif
                    </div>
                </div>
