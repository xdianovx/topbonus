                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="flex-grow-1">
                                        <h5 class="card-header align-items-center d-flex">Licens: {{ $item->title }}</h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1" style="">
                                                <li>
                                                    <a type="button" class="dropdown-item" href="{{ route('admin.licenses.index') }}">
                                                        <i class="ri-arrow-left-line align-bottom me-2 text-muted"></i> Back</a>
                                                </li>

                                                <li><a href="{{ route('admin.licenses.edit', $item->id) }}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                <li>
